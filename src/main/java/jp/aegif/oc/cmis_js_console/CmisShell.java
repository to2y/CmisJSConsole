 ...
 * 
 * inject CMIS feature
 * @author Takeshi Totani
 */
public class CmisShell extends ScriptableObject
{
	...
	public static void main(String args[]) {
		...
		try {
			...
			shell.defineFunctionProperties(names, CmisShell.class,
	...
	public static void load(Context cx, Scriptable thisObj,
			Object[] args, Function funObj)
	{
		CmisShell shell = (CmisShell)getTopLevelScope(thisObj);
		for (int i = 0; i < args.length; i++) {
